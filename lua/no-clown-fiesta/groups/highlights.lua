...
function M.highlight(palette, opts)
  return {
    ...
    Function = vim.tbl_extend("force", { fg = palette.yellow_cream or palette.cyan }, opts.styles.functions),
    Operator = { fg = palette.purple_muted or palette.fg },
    Type = vim.tbl_extend("force", { fg = palette.fg }, opts.styles.type),
    StorageClass = { fg = palette.purple_soft or palette.gray_blue },
    Structure = { fg = palette.purple_soft or palette.gray_blue },
    Typedef = { fg = palette.purple_muted or palette.fg },
    Keyword = vim.tbl_extend("force", { fg = palette.purple_soft or palette.gray_blue }, opts.styles.keywords),
    Statement = { fg = palette.purple_soft or palette.gray_blue },
    Conditional = { fg = palette.purple_soft or palette.gray_blue },
    Repeat = { fg = palette.purple_soft or palette.gray_blue },
    Label = { fg = palette.yellow_soft or palette.fg },
    Exception = { fg = palette.purple_medium or palette.red },
    Include = { fg = palette.purple_soft or palette.red },
    ...
    SpecialChar = { fg = palette.gray_warm or palette.medium_gray_blue },
