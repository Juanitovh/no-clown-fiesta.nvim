...
function M.highlight(palette, opts)
  return {
    ...
    Float = { fg = palette.yellow_warm or palette.red },
    Identifier = { fg = palette.fg },
    Function = vim.tbl_extend("force", { fg = palette.yellow_cream or palette.cyan }, opts.styles.functions),
    Operator = { fg = palette.yellow_soft or palette.fg },
    Type = vim.tbl_extend("force", { fg = palette.fg }, opts.styles.type),
    StorageClass = { fg = palette.yellow_gold or palette.gray_blue },
    Structure = { fg = palette.yellow_gold or palette.gray_blue },
    Typedef = { fg = palette.yellow_muted or palette.fg },
    Keyword = vim.tbl_extend("force", { fg = palette.yellow_gold or palette.gray_blue }, opts.styles.keywords),
    Statement = { fg = palette.yellow_gold or palette.gray_blue },
    Conditional = { fg = palette.yellow_gold or palette.gray_blue },
    Repeat = { fg = palette.yellow_gold or palette.gray_blue },
    Label = { fg = palette.yellow_soft or palette.fg },
    Exception = { fg = palette.yellow_warm or palette.red },
    Include = { fg = palette.yellow_warm or palette.red },
    PreProc = { fg = palette.yellow_muted or palette.fg },
    Define = { fg = palette.yellow_warm or palette.red },
    Macro = { fg = palette.yellow_neon or palette.cyan },
    PreCondit = { fg = palette.gray_warm or palette.medium_gray },
    Special = { fg = palette.yellow_bright or palette.fg },
    SpecialChar = { fg = palette.yellow_pale or palette.medium_gray_blue },
