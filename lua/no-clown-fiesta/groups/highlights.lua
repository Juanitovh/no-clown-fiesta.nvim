...
function M.highlight(palette, opts)
  return {
    ...
    CursorLineNr = {
      fg = palette.yellow_pale or palette.light_gray,
      bold = true,
    },
    ...
    IncSearch = { fg = palette.alt_bg, bg = palette.yellow_neon or palette.orange },
    Substitute = { fg = palette.alt_bg, bg = palette.yellow_bright or palette.orange },
    MoreMsg = { fg = palette.yellow_cream or palette.cyan },
    ...
    Function = vim.tbl_extend("force", { fg = palette.yellow_soft or palette.yellow_muted or palette.yellow_cream or palette.orange_rust or palette.cyan }, opts.styles.functions),
    ...
    Special = { fg = palette.yellow_bright or palette.fg },
